...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-40 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-2 shadow-2 md:px-6 2xl:px-11" style={{ fontFamily: 'sans-serif' }}>
        <div className="flex items-center gap-2 sm:gap-4 ">
          ...
          <span className="font-semibold text-gray-800 dark:text-white" style={{ fontSize: "20px" }}>
            Leads Management
          </span>
